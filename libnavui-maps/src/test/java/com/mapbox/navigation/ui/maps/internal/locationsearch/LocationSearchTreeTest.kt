...
class LocationSearchTreeTest {
    ...
    @Test
    fun fooTest() {
        interpolateScreenCoordinates(pointToPixelForInterpolation2)

        pointToPixelForInterpolation2.forEach {
    ...
    private val pointToPixelForInterpolation2: List<EnhancedPoint> by lazy {
        listOf(
